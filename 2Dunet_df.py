...
from data2D_df import load_train_data, load_test_data, preprocess_squeeze

K.set_image_data_format('channels_last')

project_name = '2D-Unet-df'
img_rows = 512
img_cols = 512
img_depth = 1
smooth = 1.
...
def train():
    ...
    categorical_labels = to_categorical(imgs_mask_train, num_classes=None)
    ...
    model.fit(imgs_train, categorical_labels, batch_size=1, epochs=50, verbose=1, shuffle=True, validation_split=0.10, callbacks=[model_checkpoint, csv_logger])
